...
local app_timeOut = {day=5, month=3, year=2020, hour=0, minute=0, second=0};
local app_keyword = "Ares巨他妈帅";

-- 特征
feature_leidian ={
	keys={
		time_key = os.time(app_timeOut),
        keyword = app_keyword,
        version = "inner"
    },
	system = {
    ...
    BOSS = {
        ...
        VIP = {
			图标 = {66,1224,1,true},
			BOSS1 = {"BOSS1",90,550,300,640,"EE8F0D-111111","18|-2|EE8F0B-111111,58|-2|EE8E0B-111111,82|28|F69F28-111111"},
			BOSS2 = {"BOSS2",428,554,622,634,"EE8F0D-111111","18|-2|EE8F0B-111111,58|-2|EE8E0B-111111,82|28|F69F28-111111"},
			BOSS3 = {"BOSS3",108,1018,302,1098,"EE8F0D-111111","18|-2|EE8F0B-111111,58|-2|EE8E0B-111111,82|28|F69F28-111111"},
			BOSS4 = {"BOSS4",418,1016,630,1094,"EE8F0D-111111","18|-2|EE8F0B-111111,58|-2|EE8E0B-111111,82|28|F69F28-111111"}
        },
        神殿 = {
			图标 = {306,1226,1,true},
            退出 = {676,202,1},
            ...
            第二层 = {222,296,1},
            开始挑战 = {611,1030,1},
			黑暗神殿 = {"黑暗神殿",13,584,41,619,"EDCE00-111111","7|0|FFDE00-111111,14|0|FFDE00-111111,7|5|FFDE00-111111,7|13|FFDE00-111111"},
            采集 = {"采集",298,696,364,750,"EE8F0B-111111","1|23|F69F27-111111,16|1|EF8F0C-111111,15|26|F7A22E-111111,35|14|FFFFFF-111111"},
			可挑战 = {"可挑战" ,582,1015,642,1049,"FFFFFF-111111","0|7|FFFFFF-111111,0|18|FFFFFF-111111,23|9|FFFFFF-111111,23|15|FFFFFF-111111,23|18|FFFFFF-111111"}
        }
    },
    水晶遗迹 = {
		图标 = {592,566,1},
    ...
    背包 = {
        ...
        拍卖 = {
            ...
            批量自己使用 = {460,894,1},
            关闭批量拍卖 = {644,336,1},
            物品1可用 = {"物品1可用",80,239,147,261,"D14343-111111","7|0|D24343-111111,17|0|D54343-111111,26|0|D74343-111111"},
            物品1过期 = {"物品1过期",74,242,161,271,"676767-111111","12|-1|676767-111111,27|2|696969-111111,41|9|696969-111111"},
            单个自己使用 = {251,815,1},
            单个拍卖 = {467,806,1}
        },
        批量熔炼 = {
        ...
        使用 = {
			物品1 = {103,293,1},
			使用按钮 = {"物品使用",474,465,576,520,"F09408-111111","1|28|F7A12A-111111,29|4|EF8F0C-111111,31|33|FAB556-111111,59|20|FFFFFF-111111"},
			使用成功 = {"物品使用成功",226,356,489,488,"F8EB83-111111","20|-1|FBF7BB-111111,52|-2|F5E180-111111,0|17|FBF8C8-111111,51|19|FBF8BD-111111"},
			关闭提示 = {524,848,1}
		}
    },
    角色 = {
	...
	福利 = {
        ...
        签到 = {
			图标 = {81,1177,1},
            有奖励 = {"有奖励",87,1130,126,1166,"F2603F-111111","12|-1|DF4B2D-111111,6|7|CB2309-111111,8|4|D9472C-111111"},
            可领取 = {"可领取",0,304,716,876,"96CD5B-000000","-3|17|437B11-000000,-1|62|C5753A-000000"},
            返回 = {}
        },
        祈福 = {
			图标 = {222,1172,1},
    ...
    日常 = {
		图标 = {679,379,1},
        定位点 = {"定位点",198,185,322,285,"E68642-111111","7|8|DE7B3F-111111,21|12|BF4F21-111111,30|14|C14A20-111111,23|-10|F0944D-111111,45|-41|5EECE1-111111"},
		关闭 = {"关闭",644,116,705,171,"BE5C5B-111111","15|-12|F08D75-111111,30|2|B9595A-111111,13|20|B24D4C-111111,15|3|EED8B6-111111"},
        不可领取 = {"前往按钮",522,352,672,416,"749BE0-000000","12|-1|7399DF-000000,28|0|B5CAEF-000000,47|0|FEFFFF-000000",0.9,0},
    ...
    task = {
        ...
        boss = {
            ...
            神殿 = {
				...
				进入场景 = {532,999,694,1057,"进入场景","fef5e9-555555",0.8},
                进入场景2 = {532,999,694,1057,"进入场景2","fef5e9-555555",0.8}
            },
            shendian = {
				icon = {306,1226,1},
                可挑战 = {"可挑战",325,1176,362,1206,"F15E3C-000000","11|1|D9452A-000000,5|9|C41C04-000000,5|4|DB4A2F-000000"},
...
feature_hongshouzhi ={
    ...
    BOSS = {
        ...
        神殿 = {
			...
			黑暗神殿 = {"黑暗神殿",13,584,41,619,"EDCE00-111111","7|0|FFDE00-111111,14|0|FFDE00-111111,7|5|FFDE00-111111,7|13|FFDE00-111111"},
            采集 = {"采集",298,696,364,750,"EE8F0B-111111","1|23|F69F27-111111,16|1|EF8F0C-111111,15|26|F7A22E-111111,35|14|FFFFFF-111111"},
			可挑战 = {"红手指可挑战",577,1010,651,1047,"FFFFFF-111111","0|12|FFFFFF-111111,0|21|FFFFFF-111111,29|8|FFFFFF-111111,39|18|FFFFFF-111111,45|2|FFFEFD-111111"}
        }
    },
    水晶遗迹 = {
		图标 = {592,566,1},
